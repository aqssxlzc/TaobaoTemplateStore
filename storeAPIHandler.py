...
class MainPage(webapp2.RequestHandler):
    def get(self):
        ...
        def create_file(self,filename):
            ...
            gcs_file.close()
            self.tmp_filenams_to_clean_up.append(filename)
        ...
        def crearte_file_for_list_bucket(self,bucket):
            self.response.write('Create more files for listbucket...\n')
        ...
        def delete_files(self):
            ...
            for filename in self.tmp_filenams_to_clean_up:
